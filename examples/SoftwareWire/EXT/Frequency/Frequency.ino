// УСТАНОВКА ШИМ СИГНАЛА С УКАЗАНИЕМ ЕГО ЧАСТОТЫ ДЛЯ ОДНОГО РАСШИРИТЕЛЯ ВЫВОДОВ:       //
...
//  Устанавливаем уровни на выводах модуля:                                            //
    Metro[0].frequency(10);                                                            // Устанавливаем частоту ШИМ в 10 Гц.
    Metro[0].set(0, 1023, EXT_ANALOG );                                                // Устанавливаем на 0 выводе аналоговый уровень (сигнал ШИМ) равный 1023 (25%).
    Metro[0].set(1, 2047, EXT_ANALOG );                                                // Устанавливаем на 1 выводе аналоговый уровень (сигнал ШИМ) равный 2047 (50%).
    delay(2000);                                                                       //
    Metro[0].frequency(10000);                                                         // Устанавливаем частоту ШИМ в 10 кГц.
    Metro[0].set(0, 3071, EXT_ANALOG );                                                // Устанавливаем на 0 выводе аналоговый уровень (сигнал ШИМ) равный 3071 (75%).
