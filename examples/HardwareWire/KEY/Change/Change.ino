// ПРИМЕР РЕАГИРОВАНИЯ НА ИЗМЕНЕНИЕ СОСТОЯНИЯ ОДНОЙ КНОПОКИ:                           //
                                                                                       //
...
//  Если состояние кнопки изменилось:                                                  //
    if( Metro[0].read(KEY_CHANGED) ){                                                  // Если кнопка была нажата, а теперь отпущена, или наоборот, то ...
//      Включаем или выключаем светодиод на плате Arduino:                             //
        digitalWrite( LED_BUILTIN, Metro[0].read(KEY_PRESSED) );                       // Данное действие выполняется однократно, так как оно находится в условии if(состояние кнопки изменилось){...}
    }                                                                                  //
}                                                                                      //