// ПРИМЕР ВЫВОДА ЧИСЕЛ НА ОДИН СВЕТОДИОДНЫЙ ИНДИКАТОР:                                 //
                                                                                       //
...
uint8_t sum;                                                                           // Объявляем переменную для хранения количества найденных модулей Metro.
                                                                                       //
char toChar(int i){i%=10; return i+'0';}                                               // Определяем функцию преобразования числа в символ.
                                                                                       //
void setup(){                                                                          //
...
//  Проверяем наличие модулей Metro на шине I2C:                                       //
    ...
    delay(100);                                                                        //
                                                                                       ...
                                                                                       //
void loop(){                                                                           //
char mySimbol;                                                                         // Создаём переменную для хранения символа.
    Metro[0].set( toChar(2) );                                                         // Выводим число преобразованное в символ.
    delay(1000);                                                                       // Ждём 1 секунду.
    Metro[0].set('+');                                                                 // Выводим символ.
    delay(1000);                                                                       // Ждём 1 секунду.
    Metro[0].set( toChar(2) );                                                         // Выводим число преобразованное в символ.
    delay(1000);                                                                       // Ждём 1 секунду.
    Metro[0].set('=');                                                                 // Выводим символ.
    delay(1000);                                                                       // Ждём 1 секунду.
    Metro[0].set( toChar(2+2) );                                                       // Выводим число преобразованное в символ.
    delay(1000);                                                                       // Ждём 1 секунду.
