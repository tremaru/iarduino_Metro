...
#define			MOD_1RM					0x15														//	Тип модуля - Одноканальное реле электромеханическое.
																									//
...
#include		<iarduino_Metro_1RM.h>																//	Подключаем файл iarduino_Metro_1RM.h - для работы с одноканальным реле электромеханическим.
																									//
class iarduino_Metro{																				//
	...
	/**	Конструктор класса: **/																		//
		iarduino_Metro(uint8_t i=0){																//	Конструктор основного класса.										(аргументы: i - тип модуля (MOD_KEY - кнопка, MOD_RGB - светодиод, ...) )
			...
			switch(model){																			//	Выбираем тип модуля с которым предстоит работать через объект данного класса.
				...
				#endif																				//
				#ifndef Metro_Disable_1RM															//	Если не объявлена константа запрещающая использование данного модуля, то ...
				case MOD_1RM:	objClass = new iarduino_Metro_1RM;	break;							//	Присваиваем указателю objClass ссылку на новый объект производного класса в соответствии с атрибутом указанным при объявлении объекта данного класса.
				#endif																				//
			}																						//
		}																							//
																									//
	/**	Функции доступные пользователю: **/															//
		...
		bool		off			(int	i0=NOT2														){	switch(model){	/************	Кнопка:						**/
																														...
																														break;
																														/************	Одноканальное реле:			**/
																														case MOD_1RM:	return 		  				objClass -> action	(0,  int(address)		);			//	Отключаем реле.
																														break;
																														/************	Неизвестный модуль:			**/
																														default:		return						0;
																														break;
		...
		bool		on			(long	i0=NOT4,	int	i1=NOT2,	int	i2=NOT2,	int	i3=NOT2		){	switch(model){	/************	Кнопка:						**/
																														...
																														break;
																														/************	Одноканальное реле:			**/
																														case MOD_1RM:	return 		 				objClass -> action	(1,  int(address)		);			//	Включаем реле.
																														break;
																														/************	Неизвестный модуль:			**/
																														default:		return						0;
																														break;
